...
#define ASSERT(x) if(!( x )) gEngfuncs_gl.Host_Error( "assert failed at %s:%i\n", __FILE__, __LINE__ )
#define Assert(x) if(!( x )) gEngfuncs_gl.Host_Error( "assert failed at %s:%i\n", __FILE__, __LINE__ )
...
#define ENGINE_GET_PARM_ (*gEngfuncs_gl.EngineGetParm)
...
#define Mem_Malloc( pool, size ) gEngfuncs_gl._Mem_Alloc( pool, size, false, __FILE__, __LINE__ )
#define Mem_Calloc( pool, size ) gEngfuncs_gl._Mem_Alloc( pool, size, true, __FILE__, __LINE__ )
#define Mem_Realloc( pool, ptr, size ) gEngfuncs_gl._Mem_Realloc( pool, ptr, size, true, __FILE__, __LINE__ )
#define Mem_Free( mem ) gEngfuncs_gl._Mem_Free( mem, __FILE__, __LINE__ )
#define Mem_AllocPool( name ) gEngfuncs_gl._Mem_AllocPool( name, __FILE__, __LINE__ )
#define Mem_FreePool( pool ) gEngfuncs_gl._Mem_FreePool( pool, __FILE__, __LINE__ )
#define Mem_EmptyPool( pool ) gEngfuncs_gl._Mem_EmptyPool( pool, __FILE__, __LINE__ )
