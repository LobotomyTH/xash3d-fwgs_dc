...
DEFINES = -DNDEBUG -D_KOS_ -D_SH4_ -DXASH_BUILD_COMMIT="64726f13-dirty" -DXASH_BUILD_BRANCH="master" -DXASH_STATIC_LIBS=1 -DXASH_GAMEDIR="valve" -DXASH_LOW_MEMORY=1 -DXASH_ENABLE_MAIN=1 -DDBGHELP=1 -DPSAPI_VERSION=1 -DXASH_REF_SOFT_ENABLED=0 -DXASH_REF_GL_ENABLED=1 -D_CRT_SILENCE_NONCONFORMING_TGMATH_H=1 -DHAVE_TGMATH_H=0 -DHAVE_STRNICMP=1 -DHAVE_STRICMP=1 -D_snprintf=snprintf -DXASH_SDL=12
